...
HD_PWD='F:/FPGA/Basys3/project/11_easyclock/prj/easyclock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log easyclock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source easyclock.tcl -notrace
