...
HD_PWD='F:/FPGA/Basys3/project/11_easyclock/prj/easyclock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log easyclock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source easyclock.tcl
