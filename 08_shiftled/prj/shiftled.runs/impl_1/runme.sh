...
HD_PWD='F:/FPGA/Basys3/project/08_shiftled/prj/shiftled.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source shiftled.tcl -notrace
