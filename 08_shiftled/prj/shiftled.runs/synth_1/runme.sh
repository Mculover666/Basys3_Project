...
HD_PWD='F:/FPGA/Basys3/project/08_shiftled/prj/shiftled.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftled.tcl
