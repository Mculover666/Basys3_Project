...
HD_PWD='F:/FPGA/Basys3/project/08_flashled/prj/flashled.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flashled.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flashled.tcl -notrace
