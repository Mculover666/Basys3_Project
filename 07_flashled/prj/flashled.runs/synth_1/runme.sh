...
HD_PWD='F:/FPGA/Basys3/project/08_flashled/prj/flashled.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flashled.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flashled.tcl
